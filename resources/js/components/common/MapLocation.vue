...
export default {
    ...
    data() {
        return {
            userLatitude: -13.96490491235371,
            userLongitude: 33.786818053720076,
            markers: [],
            OriginalMarker: null,
            draggedMaker: null,
            markerSearch: null,
    ...
    methods: {
        ...
        openLocationMap() {
            ...
            Swal.fire({
                ...
                "<div class='row' id='nsyea-map-container' style='height: 400px; margin: 10px 3px;'></div>",
        ...
        drawMap(lat, lng){
            ...
            var mapId = document.getElementById('nsyea-map-container'),
                map;
