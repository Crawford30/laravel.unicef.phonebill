...
class PaymentReceiptReconcilledAdminEmail extends Mailable
{
    ...
    {
        return $this->markdown('emails.payment_receipt_reconcilled_admin')->subject('Phone Bill Payment Settled');
    }
}